            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-[#1877F2] hover:bg-[#0d6efd] text-white border-none"
                  asChild
                >
                  <a
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-[#1DA1F2] hover:bg-[#0c85d0] text-white border-none"
                  asChild
                >
                  <a
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-[#0A66C2] hover:bg-[#0a5cb2] text-white border-none"
                  asChild
                >
                  <a
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-[#25D366] hover:bg-[#20bd5a] text-white border-none"
                  asChild
                >
                  <a
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-[#E60023] hover:bg-[#d20020] text-white border-none"
                  asChild
                >
                  <a
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-10 h-10 bg-gray-600 hover:bg-gray-700 text-white border-none"
                  asChild
                >
                  <a
