            ...
            {highlightedCategories.map((category, index) => (
              ...
              >
                <div className="h-40 bg-gradient-to-br from-brand-dark to-brand-blue-800 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="w-20 h-20 rounded-full bg-brand-gold/20 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {CATEGORIES.map((category, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-brand-dark to-brand-blue-800 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
